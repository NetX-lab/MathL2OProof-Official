...
class LogisticL1(BaseOptimizee):
    ...
    def initialize(self, seed):
        ...
        self.set_var('B', torch.ones(self.batch_size, self.input_dim,
                     1, requires_grad=True).to(self.device))
        self.set_var('C', torch.ones(self.batch_size, self.input_dim,
                     1, requires_grad=True).to(self.device))
    ...
    def grad_lipschitz(self):
        ...
        #  
        XDX = torch.matmul(self.W.transpose(-2, -1), self.W) / self.W.shape[1] # * D
