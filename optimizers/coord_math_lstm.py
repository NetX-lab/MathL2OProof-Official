...
class CoordMathLSTM(nn.Module):
    ...
    def forward(
        ...
        #  / self.init_grad_norm_smooth
        lstm_input2 = optimizees.X
        #  / self.init_vble_norm_smooth

        # lstm_input3 = optimizees.get_grad(
        #     grad_method='subgrad_nonsmooth',
        #     compute_grad=self.training,
        #     retain_graph=self.training,
        # )
        # lstm_input_c = lstm_input3[0] / self.init_subgrad_norm_c
        # lstm_input_d = lstm_input3[1] / self.init_subgrad_norm_d
