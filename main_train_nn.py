...
from optimizees.cnn import MnistCNN
...
optimizees = MnistCNN(opts.train_batch_size, opts.test_batch_size, opts.device)
...
if not opts.test:
    ...
    time_end = time.time()
    opts.logger("Total training time: {}".format(time_end - time_start))
else:
