...
#     --init-lr 0.0000001 \
#     --optimizer-training-steps 100    --unroll-length 100 \
#     --save-dir SGDlr0.0000001-T100-rand1orth-6450-QP-L2O-PShallow-SgleLoss-DNN-DetachState-sigmoid-ZeroX0
...
#     --init-lr 0.00001 \
#     --optimizer-training-steps 100    --unroll-length 100 \
#     --save-dir SGDlr0.0000001-T100-rand1orth-128110-QP-L2O-PShallow-SgleLoss-DNN-DetachState-sigmoid-ZeroX0
...
python main_train_anlys.py --config ./configs/1_qp_training_train_anlys.yaml \
    ...
    --init-lr 0.0000001 \
    --optimizer-training-steps 100    --unroll-length 100 \
    --save-dir SGDlr0.0000001-T100-rand1orth-256200-QP-L2O-PShallow-SgleLoss-DNN-DetachState-sigmoid-ZeroX0
